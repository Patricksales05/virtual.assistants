...
if (isset($_SESSION['user_id'])) {
    ...
    if ($role === 'admin') {
        ...
        exit();
    } elseif ($role === 'staff' || $role === 'staff member') {
    ...
    <script>
        ...
        if (urlParams.get('success') === 'registered') {
            Swal.fire({
                ...
                text: 'Your account is pending approval from the Operations Manager. Please wait for activation.',
                background: '#1e293b',
                color: '#f8fafc',
        ...
        if (urlParams.get('error') === 'not_approved') {
            Swal.fire({
                ...
                text: 'Your account is currently waiting for approval from the Operations Manager. Please try again later.',
                background: '#1e293b',
                color: '#f8fafc',
                confirmButtonColor: '#6366f1'
            });
