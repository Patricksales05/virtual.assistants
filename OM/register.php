...
<body>
    <div class="video-bg-container">
        <video autoplay muted loop playsinline id="bg-video">
            <source src="image/a Cinematic Fitness Video...SONY FX6.mp4" type="video/mp4">
        </video>
    </div>
    ...
    <script>
        ...
        if (urlParams.has('error')) {
            ...
            if (error === 'password_mismatch') message = 'Passwords do not match. Please verify your entries.';
            if (error === 'already_exists') message = 'The username or email address is already registered.';
